...
REPORT_MAX_CONTEXT_LENGTH = int(os.getenv('REPORT_MAX_CONTEXT_LENGTH', 24000)) # New for reports
...
NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD", "password") # Use environment variables in production!
