...
OLLAMA_MODEL = os.getenv('OLLAMA_MODEL', 'tinyllama') # Default model for generation/analysis
OLLAMA_EMBED_MODEL = os.getenv('OLLAMA_EMBED_MODEL', 'nomic-embed-text') # Default model for embeddings
...
# Chat Configuration
CHAT_CONTEXT_BUFFER_SIZE = int(os.getenv('CHAT_CONTEXT_BUFFER_SIZE', 4)) # Number of recent Q/A pairs for context
