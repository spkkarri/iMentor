...
# from backend.protocols import PDFExportTool
...
# Utility function to export content to PDF using PDFExportTool

def export_content_to_pdf(content: str, output_path: str) -> bool:
    """
    Exports the provided string content to a PDF file at the specified output path using PDFExportTool.
    ...
    """
    tool = PDFExportTool()
    return tool.export_to_pdf(content, output_path)
